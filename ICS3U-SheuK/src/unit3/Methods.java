...
public class Methods {
    ...
    Using Static Methods
		...
		System.out.println("This school year is hard.");
    ...
    You as the user don't know how it works, but because someone has made it, you can simply use it again and again.
		...
		//passing the value of myNum to the method doubleNumber and 
		//printing out double the number 
		int myNum = 30;
		myNum = doubleNumber(myNum);
		System.out.println(myNum);

		//Explain what is happnenig
		//Printing out the double of 5, which is 10
